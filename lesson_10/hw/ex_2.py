...
dog = FabricAnimal.build(animal_type="Dog", name="Rex", age=3, color="black", voice="gaf")
print(dog)

bird = FabricAnimal.build(animal_type="Bird", name="Kakadoo", age=10, color="pink", voice="aaa-aa")
print(bird)

fish = FabricAnimal.build(animal_type="Fish", name="Pike", age=15, color="pink", voice="aaa-aa", predatory=True)
print(fish)
